...
class ODRefreshControl: UIControl {
    ...
    init(in scrollView: UIScrollView, activityView: UIView? = nil) {
    ...
    override func observeValue(forKeyPath keyPath: String?, of object: Any?, change: [NSKeyValueChangeKey : Any]?, context: UnsafeMutableRawPointer?) {
        ...
        //Top semicircle
        path.addArc(center: topOrigin, radius: currentTopRadius, startAngle: 0, endAngle: CGFloat(M_PI), clockwise: true)
        ...
        path.addCurve(to: leftDestination,
                      ...
                      control2: leftCp2)
        //Bottom semicircle
        path.addArc(center: bottomOrigin, radius: currentBottomRadius, startAngle: CGFloat(M_PI), endAngle: 0, clockwise: true)
        ...
        if !triggered {
            ...
            highlightPath.addArc(center: topOrigin, radius: currentTopRadius, startAngle: 0, endAngle: CGFloat(M_PI), clockwise: true)
            highlightPath.addArc(center: CGPoint(x: topOrigin.x, y: topOrigin.y + 1.25), radius: currentTopRadius, startAngle: CGFloat(M_PI), endAngle: 0, clockwise: false)
            ...
            toPath.addArc(center: topOrigin, radius: radius, startAngle: 0, endAngle: CGFloat(M_PI), clockwise: true)
            ...
            toPath.addArc(center: topOrigin, radius: radius, startAngle: CGFloat(M_PI), endAngle: 0, clockwise: true)
            toPath.addCurve(to: CGPoint(x:  topOrigin.x + radius, y: topOrigin.y),
                            control1: CGPoint(x:  topOrigin.x + radius, y: topOrigin.y),
                            control2: CGPoint(x:  topOrigin.x + radius, y: topOrigin.y))
            toPath.closeSubpath()
